...
window.LAYERPITCH_HELP = {
  fr: {
    library: {
      ...
      implementationNote: "Note libre à ton attention, reprise telle quelle dans la fiche d'implémentation de la collection (onglet Collections). Peut contenir du jargon spécifique à un moteur si tu veux (ex. suggestion de RTPC) — contrairement au reste de la fiche, générée en langage neutre.",
    },
    packs: {
      packIllustration: "Image principale affichée en haut de la page publique de cette collection.",
      ...
      packPresentation: "Texte de présentation affiché sur la page publique de la collection, au-dessus de la liste des morceaux. Sélectionne du texte puis Cmd+K pour y insérer un lien.",
      packBuyable: "Affiche un bouton d'achat sur la page publique de la collection. Aucun paiement réel n'est traité aujourd'hui — le lien peut pointer vers autre chose en attendant (mail, formulaire) si besoin.",
      ...
      implementationSkills: "Réglage global pour tout le site, pas par collection. Coche les logiciels que tu maîtrises (Wwise, FMOD, Unity, Unreal) : un message le mentionnant apparaît sur la page publique de chaque collection, listant uniquement ceux cochés. Aucune case cochée = aucun message affiché.",
      implementationSheetBtn: "Génère à la volée un document (texte + JSON) décrivant le comportement musical de chaque morceau de cette collection en langage neutre — nombre de couches, seuils d'intensité, BPM, points de boucle, structure intro/segment/outro selon le mode. Rien n'est stocké ni publié, uniquement généré au moment où tu cliques.",
      packAppearance: "Couleurs de fond et de texte propres à la page de cette collection — indépendantes de celles de l'AdReel qui y renvoie.",
      packTracks: "Les morceaux de la bibliothèque inclus dans cette collection, dans l'ordre d'affichage sur sa page publique.",
    },
    appearance: {
      publishLang: "Langue de l'interface publique pour cet AdReel — n'affecte pas ton contenu (titres, textes, témoignages), qui reste dans la langue où tu l'as écrit. Les collections liées depuis cet AdReel suivent automatiquement ce choix.",
  ...
  en: {
    library: {
      ...
      implementationNote: "Free note for your own use, reused as-is in the collection's implementation sheet (Collections tab). Can contain engine-specific jargon if you want (e.g. a suggested RTPC) — unlike the rest of the sheet, which is generated in neutral language.",
    },
    packs: {
      packIllustration: "Main image shown at the top of this collection's public page.",
      ...
      packPresentation: "Presentation text shown on the collection's public page, above the track list. Select text then Cmd+K to insert a link.",
      packBuyable: "Shows a buy button on the collection's public page. No real payment is processed today — the link can point to something else in the meantime (email, form) if needed.",
      ...
      implementationSkills: "Global setting for the whole site, not per collection. Check the software you're proficient with (Wwise, FMOD, Unity, Unreal): a message mentioning it appears on each collection's public page, listing only the checked ones. No box checked = no message shown.",
      implementationSheetBtn: "Generates on the fly a document (text + JSON) describing the musical behavior of each track in this collection in neutral language — number of layers, intensity thresholds, BPM, loop points, intro/segment/outro structure depending on mode. Nothing is stored or published, only generated the moment you click.",
      packAppearance: "Background and text colors specific to this collection's page — independent from those of the AdReel linking to it.",
      packTracks: "The library tracks included in this collection, in the order they're shown on its public page.",
    },
    appearance: {
      publishLang: "The public interface language for this AdReel — doesn't affect your own content (titles, texts, testimonials), which stays in the language you wrote it in. Collections linked from this AdReel automatically follow this choice.",
